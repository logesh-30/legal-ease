    ...
    <div className="space-y-12">
      ...
      <section className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {[
          ...
          { icon: MapPin, label: ta ? 'அலுவலகங்கள்' : 'Offices Mapped', value: '5', color: 'var(--mint)' },
          { icon: Users, label: ta ? 'குடிமக்களுக்கு உதவ முடியும்' : 'Citizens can be Helped', value: '10K+', color: 'var(--sky)' },
